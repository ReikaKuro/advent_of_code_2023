...
for line in input.split('\n'):
    ...
    for first_digit in line:
        if first_digit.isdigit():
            combined_number = first_digit
            break
    for last_digit in reversed(line):
        if last_digit.isdigit():
            combined_number = f'{combined_number}{last_digit}'
            output += int(combined_number)
            break
